...
import CreditUsageChart from '../(home)/billing/_component/CreditUsageChart';
...
async function BalanceCard() {
  const useBalance = await getAvailableCredits();
  return (
    <Card
      className="bg-gradient-to-br from-primary/10 via-primary/5 to-background border-primary/20 shadow-lg flex justify-between 
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-4xl font-bold text-primary">
              <ReactCountUpWrapper value={useBalance} />
            </p>
          </div>
          <CoinsIcon
            size={140}
